...
/*
不喜欢数学题，抄了个leetcode的题解
Math problem is boring, solution is copied from leetcode

执行用时 :3 ms, 在所有 Java 提交中击败了94.28%的用户
内存消耗 :34.8 MB, 在所有 Java 提交中击败了75.76%的用户
 */
